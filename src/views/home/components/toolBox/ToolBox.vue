<template>
  <div class="tool-box">
    ...
    <a class="tool-item" :href="url[1]">
      <svg width="40" height="40" viewBox="0 0 40 40" class="GlobalWrite-navIcon" fill="currentColor">
        <g fill="#FF0033" fill-rule="evenodd">
          <circle cx="20" cy="20" r="20" opacity=".12"></circle>
    ...
    <a class="tool-item" :href="url[2]" target="_blank">
      <svg width="40" height="40" viewBox="0 0 40 40" class="GlobalWrite-navIcon" fill="currentColor">
    ...
    <a class="tool-item" :href="url[3]">
      <svg width="40" height="40" viewBox="0 0 40 40" class="GlobalWrite-navIcon" fill="currentColor">
        <g fill="#FF99CC" fill-rule="evenodd">
          <circle cx="20" cy="20" r="20" opacity=".12"></circle>
...
<script>
  export default {
    ...
    data() {
      return {
        url: ["javascript:;", "javascript:;", "/write", "javascript:;"]
      }
    },
    methods: {
      // itemClick(path) {
